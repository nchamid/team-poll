...
| Data Sensitivity, Compliance Flag | Section 4: Data & Inputs (Sensitivity), Section 10: Instructions for Claude |
...
| Desired Deadline, Priority, Urgency | Section 9: Timeline |
...
| Approval chain (new) | Section 8: Approvals Required |
