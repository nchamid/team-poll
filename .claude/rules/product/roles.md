...
|---|---|
| Data appears privileged and Section 10 is incomplete | AI Solutions Lead |
...
- Flag if an implementation approach would conflict with constraints in the template (especially Section 6 and Section 10)
...
- Validate that data sensitivity handling matches Section 4 and Section 10 of the template
- Document test results and record QA sign-off in Section 8 (Approvals Required) of the template
...
| QA & Testing | QA | Analyst + Stakeholder | Test results + QA sign-off in Section 8 of template |
| Stakeholder Review (UAT) | Analyst + Requestor | Approvers (IT, Legal, Exec) | Updated template with UAT sign-off |
| Approvals | IT / Legal / Exec Sponsor | Developer | All approvals confirmed in Section 8 of template |
